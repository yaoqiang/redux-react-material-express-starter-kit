    ...
    return (
      <div>
          <AppBar
              ...
              iconElementRight={
                <div>
                  <a target="_blank" href="https://github.com/WapGeaR/redux-react-material-boilerplate">
                    <IconButton iconStyle={{color: '#fff'}} iconClassName="fa fa-github" />
                  </a>
                  <a target="_blank" href="http://www.material-ui.com/#/components/app-bar">
                    <IconButton iconStyle={{color: '#fff'}} iconClassName="fa fa-rocket" />
                  </a>
                  </div>
                }
          />
